 ...
 * <h1>Pascal</h1>
 *
 * <p>Compiler or interpret a Pascal source program</p>
 */
public class Pascal {
    ...
    private static final String INTERPRRETER_SUMMARY_FORMAT =
    ...
    private class BackendMessageListener implements MessageListener{
        ...
        /**
         * Called by the backend end whenever it process a message.
         * @param message the message that was sent.
         */
        @Override
        public void messageReceived(Message message) {
            ...
            switch (type){
                case INTERPRETER_SUMMARY:{
                    ...
                    float elapsedTime = (Float)body[2];
                    System.out.printf(INTERPRRETER_SUMMARY_FORMAT,executionCount,runtimeErrors,elapsedTime);
                    break;
                }
                case COMPILER_SUMMARY:{
                    Number body[] = (Number[])message.getBody();
                    int instuctionCount = (Integer)body[0];
                    float elapsedTime = (Float)body[1];

                    System.out.printf(COMPILER_SUMMARY_FORMAT,instuctionCount,elapsedTime);
                    break;
                }
            }
        }
