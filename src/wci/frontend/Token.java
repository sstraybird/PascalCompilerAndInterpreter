 ...
 * <h1>Token</h1>
 *
 * <p>The framework class that represents a token returned by the scanne</p>
 */
public class Token {
    protected TokenType type;       //language-specific token types
    ...
    /**
     * Default method to extract onlu one-character tokens from source.
     * Subclasses can override3 this method to construct language-specific tokens.
     * After extracting the token,the current source lien position will be one beyond the last token character.
     * @throws Exception if an error occurred.
     */
     ...
     * @return the next character form the source after moving forward.
     * @throws Exception if an error occurred.
     */
