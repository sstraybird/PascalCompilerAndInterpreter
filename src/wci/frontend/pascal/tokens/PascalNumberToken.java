 ...
 *
 * <p>Pascal number toknes (integer and real).</p>
 */
public class PascalNumberToken extends PascalToken {
    ...
    protected void extractNumber(StringBuilder textBuffer) throws Exception{
        ...
        type = INTEGER ;                // assume INTEGER toekn type for now
    ...
    private int computeIntegerValue(String digits){
        ...
        int integerValue = 0;
        int preValue = -1;          // overflow occurred if preValue > integerValue
        int index = 0;

        // Loop over the digits to compute the integer value as long as there is no overflow
    ...
    private float computeFloatValue(String wholeDigits,String fractionDigits,String exponentDigits,char exponentSign){
        ...
        // If there are any fraction digits, adjust the exponent value and append the fraction digits.
        ...
        // Adjust the float value based on teh exponent value.
        if(exponentValue != 0){
