 ...
 */
public class CompundStatementParser extends StatementParser{
    /**
     * Constructor
     *
     * @param parent the parent parser.
     */
    public CompundStatementParser(PascalParserTD parent) {
        super(parent);
    }
    ...
    public ICodeNode parse(Token token) throws Exception{
        ...
        statementParser.parseList(token,compoundNode,END, PascalErrorCode.MISSING_END);
        return compoundNode;
    }
}
